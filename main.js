...
// let result = results.filter(item => item.order.freight < 1);
// console.log(result);

// 2) customerID ERNSH olan neçə ədəd sifariş var?

// let customer = results.filter(item => item.order.customerId === "ERNSH")
// console.log(` customerID ERNSH olan sifaris sayi : ${customer.length}`);
// console.log(customer);

// 3) employeeİd- görə sortlayın

// let employed = results.filter(item => item.order.employeeId);
// let newEmploye = employed.sort((a, b) => a.order.employeeId - b.order.employeeId);
// console.log(newEmploye);

// 4) OrderDetailsi 3-dən çox olanları console-a yazdır

// let orderDetail = results.filter(item => item.orderDetails.length > 3)
// console.log(orderDetail);

// 5) İD-si 11075 olanı tap və yazdır. (find)

// let id = results.find(item => item.order.id === 11075);
// console.log(id);
